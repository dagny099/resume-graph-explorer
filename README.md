...
- ✅ Entity normalization pipeline: type-pool separation, alt_labels tracking, phase gating, user_verified anchor protection
...
- ✅ Session persistence
- ⏸️ Evaluation tests (`test_evaluation.py`) skip until ground truth fixtures are authored — see `docs/EVALUATION_PLAN.md`
